...
def primary_tables():
    tables = []
    #All Suites
    suites_table = Table('suites', suite_columns())
    tables.append(suites_table)
    #All Traits
    traits_table = PkNameTable('traits', 'trait')
    tables.append(traits_table)
    #All Priorities
    priorities_table = PkNameTable('priorities', 'priority')
    tables.append(priorities_table)
    #All Families
